...
var EventDispatcher, Model, Promise, View, cssError, empty, emptyDom, emptyEventDispatcher, emptyModel, emptyPathMap, emptyRes, errorHtml, escapeHtml, escapeInlineScript, files, isProduction, loadTemplatesScript, racer, templateError, trim, uglify, _ref, _ref1;
...
_ref1 = racer.util, Promise = _ref1.Promise, isProduction = _ref1.isProduction;
...
View.prototype._load = function(isStatic, callback) {
  var appFilename, clientName, count, errors, finish, instances, js, options, promise, require, root, templates, _ref2,
    _this = this;
  if (isProduction) {
    this._watch = false;
  ...
  if (isStatic) {
    ...
    _ref2 = files.parseName(appFilename, options), root = _ref2.root, clientName = _ref2.clientName, require = _ref2.require;
    this._root = root;
