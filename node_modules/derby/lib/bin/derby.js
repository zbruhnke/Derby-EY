...
var ANSI_CODES, APP_COFFEE, APP_HTML, APP_JS, APP_STYL, BASE_STYL, GITIGNORE_COFFEE, GITIGNORE_JS, MAKEFILE_COFFEE, README, RESET_STYL, SERVER, SERVER_COFFEE, SERVER_ERROR_COFFEE, SERVER_ERROR_JS, SERVER_JS, abort, basename, createProject, derby, emptyDirectory, exec, fs, join, makeCallback, mkdir, mkdirp, newProject, packageJson, printUsage, program, render, resolve, style, styleTag, writeFile, _404_HTML, _404_STYL, _ref;
  ...
  return mkdir(dir, function() {
    ...
    if (useCoffee) {
      ...
      mkdir(serverScripts, wait(function() {
        writeFile(join(serverScripts, 'index.coffee'), render(SERVER_COFFEE, {
          app: app
        }), wait());
        return writeFile(join(serverScripts, 'serverError.coffee'), render(SERVER_ERROR_COFFEE, {
          app: app
        }), wait());
      }));
      ...
      mkdir(serverScripts, wait(function() {
        writeFile(join(serverScripts, 'index.js'), render(SERVER_JS, {
          app: app
        }), wait());
        return writeFile(join(serverScripts, 'serverError.js'), render(SERVER_ERROR_JS, {
          app: app
        }), wait());
      }));
